...
export class SettingsService {
  ...
  boardSettings$ = new BehaviorSubject<any>({ boardLength: 10, boardWidth: 10, battleshipNum: 10, createIslands: false })
  ...
  setBoardSettings(boardLength: number, boardWidth: number, battleshipNum: number, createIslands: boolean): void {
    this.boardSettings$.next({ boardLength, boardWidth, battleshipNum, createIslands })
  }
